        ...
        <div class="row gy-sm-5 gy-4 align-items-center">
            ...
            <div class="col-xl-6 d-flex justify-content-center align-items-center flex-column">
                <div class="banner-two__content text-center">
                    ...
                    <h1 class="banner-two__title mb-3">Free Motion Array Downloader</h1>                   
                    <p class="banner-two__desc">
                        Get Motion Array files instantly with our free downloader. No hassle, just fast and easy downloads!
                    </p>
                    ...
                    <form action="{{ route('request.download') }}" method="POST" class="search-box" id="motionArrayForm">
                        @csrf
                        <input 
                            type="text" 
                            class="common-input common-input--lg pill shadow-sm" 
                            placeholder="Enter Motion Array URL: e.g., https://motionarray.com/item-name" 
                            id="motionArrayInput"
                            name="motionarray_url"
                        >
                    
                        <!-- Tombol download yang hanya aktif jika URL valid -->
...
<script>    
    ...
    document.getElementById('downloadButton').addEventListener('click', function () {
        ...
        const input = document.getElementById('motionArrayInput').value;
    ...
    function showEmailPrompt(envantoUrl) {
        Swal.fire({
            title: 'Attention',
            text: 'The Motion Array file you are looking for is not available in our database. Leave your email, and we will notify you when it becomes available.',
            input: 'email',
    ...
    function submitEmailAndUrl(envantoUrl, email = null) {
        ...
        fetch('{{ route('request.download.motion') }}', {
            method: 'POST',
            headers: {
