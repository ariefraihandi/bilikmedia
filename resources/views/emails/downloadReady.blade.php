...
<body>
    <div class="container">
        ...
        <div class="content">
            <p><strong>{{ $title }}</strong> is now ready for download.</p>
            <a href="{{ $downloadUrl }}" style="display: inline-block; background-color: #4e58f0; color: white; padding: 10px 20px; text-decoration: none; border-radius: 4px; font-size: 16px;">Download Now</a>
        </div>
        <br>
        <br>
        <br>
