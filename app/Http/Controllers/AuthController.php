...
class AuthController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        try {
            ...
            $refferedBy = $request->input('reff', session('reff', null)); // Ambil dari input atau session
            ...
            Alert::error('Registration Failed', 'An error occurred during registration. Please try again.');
